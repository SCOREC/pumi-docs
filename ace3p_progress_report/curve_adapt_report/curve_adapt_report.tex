...
In this report, we provide a details state of the Omega3P project. In particular Sec. \ref{load_balance} describes what has been done for \dots . Section \ref{adaptive_loop} discusses the details of the adaptive loop implementations and provides some example results. Finally, Sec. \ref{higher_order_geom} provides a quick overview of the steps taken towards moving to higher-order geometric meshes.
...
\section{Fully Parallel In-Memory Mesh Integration}
...
\section{\label{high_order_goem}Moving Towards Higher-Order Geometries}
