...
In this report, we provide some details on state of the Omega3P project. In particular, Sec. \ref{load_balance} describes what has been done for \dots . Section \ref{in_memory} provides the details of in-memory mesh integration. Section \ref{adaptive_loop} discusses the details of the adaptive loop implementations and provides some example results. Finally, Sec. \ref{high_order_geom} provides a quick overview of the steps taken towards moving to higher-order geometric meshes.
