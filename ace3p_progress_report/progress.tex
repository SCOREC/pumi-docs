...
Phase I system.
The Omega3P+PUMI average number of ghost + owned vertices and elements per-part
is less than 1.8\% higher than the Omega3P counts at 32 parts.
At 64 and 128 parts the average entity counts of Omega3P+PUMI is less than 0.2\%
...
At 128 parts ParMA reduces the vertex imbalance by 24 points and the element
imbalance by 27 points.

\begin{figure}[ht]
\centering
  \includegraphics[width=\textwidth]{vtx-imb.eps} \\
  \caption{\label{fig:vtx} Vertex imbalance.}
\end{figure}

\begin{figure}[ht]
\centering
  \includegraphics[width=\textwidth]{elm-imb.eps} \\
  \caption{\label{fig:elm} Element imbalance.}
\end{figure}
