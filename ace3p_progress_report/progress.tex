...
%Blah blah about what the figure shows and tradeoffs that are found
Figure \ref{fig:convert_mem} shows the memory usage after reading for our approach and 
the original Omega3P run. 
%blah blah about what the memory figure shows
...
\centering
  ...
  \caption{\label{fig:vtx} Total vertex count and (total) vertex imbalance.}
\end{figure}
...
\centering
  ...
  \caption{\label{fig:elm} Total element count and (total) element imbalance.}
\end{figure}
