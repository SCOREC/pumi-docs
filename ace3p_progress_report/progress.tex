...
(https://github.com/SCOREC/core)~\cite{ibanez2015pumi},
supports mesh-based parallel simulations with mesh-adaptation, load balancing,
and tensor-field services.
Critical to the implementation of these servies is the {\textit complete}
...
approximetly 500B/element using 64 bit indices, and provides $O(1)$ mesh adjacency
queries.
