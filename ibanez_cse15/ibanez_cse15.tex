...
\begin{center}
\includegraphics[width=0.8\textwidth]{ibanez_cse15-7.png}
\end{center}
...
\item
C's realloc can be more efficient due
to mmap on Linux systems.
\end{itemize}
\begin{center}
\includegraphics[width=0.6\textwidth]{ibanez_cse15-9.png}
\end{center}
}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{ibanez_cse15-8.png}
\end{center}
}
