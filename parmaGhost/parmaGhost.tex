...
\Procedure{write}{}
  ...
  \ForEach {$vtx number$}
    \If {vtxs[vtx number] is empty}
      \State $vtxs[vtx number] = random part number$
    \EndIf
  \EndFor
  \State Open file
  \ForEach {$v \in vtxs$}
