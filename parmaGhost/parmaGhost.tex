...
\Procedure{write}{}
  ...
  \ForEach {$owned \: vtx$}
    \State // target is the part denoted by vtx number/vtx per part
    \State send vtx number and part number to target process
  \EndFor
