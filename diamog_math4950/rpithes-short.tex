...
centroids to lenghten the sides. The key of our method is to improve shape 
at the cost of imbalance in the idea that the imbalance sacrificed can be 
rebalanced without losing the shape quality created by Gap. Our initial testing 
