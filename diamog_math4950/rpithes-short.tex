...
mesh adaptation framework called ParMA \cite{parma}. Thus our algorithm, Gap,
 ...
 small sides and migrate elements to increase the size of these bounaries. Here 
...
[Citation of other parma algos?]. The stopping criteria is typically to go below some balancing threshold of a certain dimension.
 
  
\section{Gap}

\section{Maximimal Independent Set}
