...
\centering
\captionsetup{justification=centering,margin=1cm}
\includegraphics[width=.8\textwidth]{MIS_problem.png}
...
\centering
\captionsetup{justification=centering,margin=1cm}
\includegraphics[width=.8\textwidth]{results_before.png}
...
M.S., "Application Specific Mesh Partition Improvement", Submitted to SIAM Journal on Scientific Computing, 2015. %not in references.bib
\end{thebibliography}
\end{singlespace}
